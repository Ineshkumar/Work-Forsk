# -*- coding: utf-8 -*-
"""
Created on Wed Jun 20 12:41:45 2018

@author: inesh
"""
import requests
page=requests.get('https://www.wunderground.com/history/airport/VIDP/2018/6/17/DailyHistory.html?req_city=New+Delhi&req_state=&req_statename=India&reqdb.zip=00000&reqdb.magic=45&reqdb.wmo=42181')
...
df.to_csv('june_17.csv', index=False)
