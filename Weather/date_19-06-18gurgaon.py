...
import requests
page=requests.get('https://www.wunderground.com/history/airport/VIDP/2018/6/19/DailyHistory.html?req_city=New+Delhi&req_state=&req_statename=India&reqdb.zip=00000&reqdb.magic=45&reqdb.wmo=42181')
...
df.to_csv('june_19.csv', index=False)         