# -*- coding: utf-8 -*-
"""
Created on Tue Jun 19 10:27:39 2018
...
face_cascade = cv2.CascadeClassifier('/media/inesh/f32962a9-22d0-44de-adc0-8bb316305013/forsk/DAY 28/haarcascade_frontalface_default.xml')
eye_cascade = cv2.CascadeClassifier('/media/inesh/f32962a9-22d0-44de-adc0-8bb316305013/forsk/DAY 28/haarcascade_eye.xml')

#test = face_cascade.load('haarcascade_frontalface_default.xml')

# Reading the given Image and converting it to Grayscale
img = cv2.imread('/media/inesh/f32962a9-22d0-44de-adc0-8bb316305013/forsk/DAY 28/baby.jpg')
